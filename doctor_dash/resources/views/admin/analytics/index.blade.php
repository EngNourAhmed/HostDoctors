...
<div class="space-y-10 animate-in fade-in duration-700">
    ...
    <div id="activityModal" class="fixed inset-0 z-[100] hidden items-center justify-center p-4">
        ...
        <div class="relative w-full max-w-4xl bg-[#0c0c0c] rounded-[40px] border border-white/10 shadow-2xl overflow-hidden pointer-events-none scale-95 opacity-0 transition-all duration-500 ease-out activity-modal-container flex flex-col" style="height: 95vh;">
            <!-- Modal Header -->
