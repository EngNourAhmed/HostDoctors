...
<div class="space-y-10 animate-in fade-in duration-700">
            ...
            <table class="w-full text-left">
                <thead>
                    <tr class="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] border-b border-white/5">
                        ...
                        <th class="pb-4 text-right">Logins</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-white/5">
    ...
    <div id="activityModal" class="fixed inset-0 z-[100] hidden items-center justify-center p-4">
        ...
        <div class="relative w-full max-w-4xl bg-[#0c0c0c] rounded-[40px] border-[3px] border-white/20 shadow-[0_0_50px_rgba(0,0,0,0.5)] overflow-hidden pointer-events-none scale-95 opacity-0 transition-all duration-500 ease-out activity-modal-container flex flex-col" style="height: 95vh;">
            <!-- Modal Header -->
